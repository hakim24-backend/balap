...
<div class="bracket-form">
	<div class="box box-info">
		<div class="box-body">
			...
			<input id="batas" class="form-control" type="number" name="batas" min="0" value="0" step=".01"><br>

			<label>Batas Atas</label>
			<input id="batas_atas" class="form-control" type="number" name="batas_atas" min="0" value="0" step=".01"><br>

			<label>Batas Bawah</label>
			<input id="batas_bawah" class="form-control" type="number" name="batas_bawah" min="0" value="0" step=".01"><br>
